...
Ein Auto-Expanding Archive stellt bei Bedarf zusätzlichen Archivspeicher bereit. Standardarchive haben 100 GB verfügbaren Speicher. Wenn das Archiv bereits größer als 100 GB gewesen ist, muss zusätzlicher Speicher vorhanden gewesen sein.
...
Übrigens: Dieser Lizenzhinweis wurde offenbar angezeigt, unabhängig davon, ob dem Benutzer eine Exchange Online Plan 2 Lizenz zugewiesen gewesen ist oder nicht:
...
Und es wurde weiterhin "unlimited storage" erwähnt, obwohl seit 2021-11-01 beim Archivieren kein "unlimited storage" mehr enthalten gewesen ist. Der Speicher ist jetzt auf 1,5 TB begrenzt.

## Zusätzliche Speicherorte prüfen

Wenn das Hauptarchiv des Postfachs sein Limit von 100 GB erreicht hat, wird ein weiterer Speicher hinzugefügt. Dieser zusätzliche Speicher heißt "Auxilary Archive" oder kurz "AuxArchive".
